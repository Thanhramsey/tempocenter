            ...
            <div class="col-md-12 col-lg-12 col-xs-12 col-12">
                ...
                <div class="col-md-6 col-pad">
                    <div class="fadeInDown" data-wow-delay="250ms" data-wow-duration="1s"
                        ...
                        <h1 class="text-beauty text-bold text-center" style="color:#fc2a40">PIANO CƠ BẢN</h1>
                        <p class="text-bold text-beauty" style="font-size:22px">Chương trình đào tạo Piano cơ bản dành
                            cho những ai
                            chưa có
                            kiến thức về piano hoặc chưa biết bắt đầu từ đâu nhưng mong muốn trở thành một “Pianist”
                            trong tương lai. Bạn sẽ được học kiến thức nhạc lý piano cơ bản, luyện ngón thành thục qua
                            các tác phẩm cổ điển và hiện đại, phát triển kỹ năng chơi đàn cả hai tay. Khóa học là nền
                            tảng tốt nhất để bạn theo đuổi các khóa học đàn piano nâng cao và chuyên nghiệp sau này.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12 col-12">
                <div class="col-md-6" style="padding: 40px 20px">
                    <div class="fadeInLeft" data-wow-delay="1s" data-wow-duration="2s"
                        ...
                        <h1 class="text-beauty text-bold text-center" style="color:#fc2a40"> MỤC TIÊU KHÓA HỌC</h1>
                        <ul class="coban-text" style="margin-top:40px">
                            <li>Cung cấp kiến thức về cách đọc các nốt nhạc, kỹ thuật chơi đàn, lịch sử âm nhạc… giúp
                                học viên hình thành hiểu biết cơ bản và vững chắc.</li>
                            <li>Bước đầu xây dựng, gợi mở khả năng cảm thụ và biểu cảm thông qua âm nhạc.</li>
                            <li> Rèn luyện bản lĩnh sân khấu, xử lý tình huống thông qua các hoạt động biểu diễn.</li>
                            <li>Hướng dẫn chơi các tác phẩm kinh điển, các bản nhạc phổ biến và thịnh hành nhằm nâng
                                cao tính ứng dụng.</li>
                            <li>Xây dựng môi trường học tập năng động, sáng tạo, tạo hứng thú trong quá trình học.</li>
                            <li>Định hướng nghề nghiệp cho những học viên có năng khiếu âm nhạc.</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-pad">
            ...
            <div class="col-md-12 col-lg-12 col-xs-12 col-12">
                ...
                <div class="col-md-6" style="padding: 40px 20px">
                    <div class="fadeInRight" data-wow-delay="1s" data-wow-duration="2s"
                        ...
                        <ul class="coban-text" style="margin-top:40px">
                            <li> Nắm vững kiến thức lý thuyết âm nhạc cơ bản.</li>
                            <li>Luyện tư thế ngồi chơi đàn chuẩn và đẹp.</li>
                            <li> Chạy các gam Trưởng và Thứ cơ bản.</li>
                            <li>Thị tấu và chơi các bản nhạc linh hoạt, đúng sắc thái.</li>
                            <li>Biểu diễn thành thục tác phẩm thuộc thể loại độc tấu cơ bản.</li>
                            <li>Hình thành phong cách biểu diễn qua các kỹ thuật: Legato, Non Legato, Staccato…</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12 col-xs-12 col-12">
                <div class="col-md-4">
                    <div class="fadeInLeft text-center" data-wow-delay="1s" data-wow-duration="3s"
                        ...
                        <a style="color:#0e0d08" class="text-beauty text-bold" href="nangcao"> KHÓA
                            PIANO NÂNG CAO</a>
